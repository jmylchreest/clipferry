...
## [0.0.3](https://github.com/jmylchreest/clipferry/releases/tag/v0.0.3) - 2026-09-23
...
- preserve screenshot data before claiming the X11 clipboard
- don't bridge our own X11 claim mirrored back by Xwayland ([#30](https://github.com/jmylchreest/clipferry/pull/30))
...
- *(deps)* bump x11rb from 0.13.2 to 0.14.0 ([#23](https://github.com/jmylchreest/clipferry/pull/23))
- release v0.0.2 ([#21](https://github.com/jmylchreest/clipferry/pull/21))
